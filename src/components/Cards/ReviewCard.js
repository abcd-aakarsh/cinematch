...
const ReviewCard = ({ author, image, content, path }) => {
  ...
  return (
    <div className="border-2 w-1/4 p-6 border-gray-700 bg-gray-900 rounded-lg shadow-md transition-transform transform hover:scale-105 flex-shrink-0">
      <div className="flex items-center mb-4">
        ...
        <p className="text-lg text-white font-semibold">{author}</p>
      </div>

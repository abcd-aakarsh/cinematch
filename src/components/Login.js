  ...
  return (
    <>
      ...
      <form
        ...
        className="absolute w-11/12 mx-auto px-6 h-fit py-8 lg:w-4/6 sm:w-3/5 md:w-1/3 xl:w-3/12 right-0 top-1/4 -translate-y-1/4 left-0 rounded-lg bg-gray-800 my-32 bg-opacity-80  "
      >

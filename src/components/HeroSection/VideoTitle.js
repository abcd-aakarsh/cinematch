const VideoTitle = () => {
  return (
    <>
      <div className="py-44 md:pt-72 px-16 lg:px-24 lg:pt-64 absolute bg-gradient-to-b lg:bg-gradient-to-r text-gray-200 from-black text-center lg:text-start  w-full lg:6/12 h-[75vh] md:h-[100vh] ">
